...
🔗 **서비스 바로가기**: [https://YOUR-FRONTEND.vercel.app](https://daejeon-travel.vercel.app/)
🎬 **시연 영상**: (영상 링크)
...
- 한국관광공사 TourAPI 4.0 (공공누리 제1유형 — 출처표시)
- Open-Meteo (CC BY 4.0) · © OpenStreetMap contributors (ODbL) · OSRM
